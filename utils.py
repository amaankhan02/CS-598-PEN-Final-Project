...
class LLMClient:
    ...
    """
    def __init__(self, api_key, model_name, temperature=0.7, top_p=0.9, max_output_tokens=150):
        """
        ...
        try:
            ...
            print(f"Gemini model '{self.model_name}' initialized successfully in LLMClient.")
    ...
    def get_response(self, prompt, max_retries=3, delay=2):
        ...
        while retries < max_retries:
            try:
                ...
                retries += 1
                print(f"Error calling Gemini API (Attempt {retries}/{max_retries}): {e}")
...
def test_llm():
    ...
    if llm_client:
        test_prompt = "Explain the concept of multi-agent reinforcement learning in one sentence."
